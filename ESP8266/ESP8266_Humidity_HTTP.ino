...
void sentHTTP(String data) {
  HTTPClient http;
  http.begin("https://test-5880-developer-edition.eu31.force.com/sensordata/services/apexrest/Arduino_Humidity__c?humidity=" + data, "CA 6B E2 3B A5 B3 54 2D 5A 61 08 5C A7 65 D4 EA 12 B6 64 54");
